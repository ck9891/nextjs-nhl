...
var getStats = function getStats(id) {
  var _useFetch = Object(_components_hooks__WEBPACK_IMPORTED_MODULE_6__["useFetch"])("https://statsapi.web.nhl.com/api/v1/teams/".concat(id));

  var _useFetch2 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_useFetch, 2);

  teamData = _useFetch2[0];
...
var TeamStandings = function TeamStandings(props) {
  var _useFetch3 = Object(_components_hooks__WEBPACK_IMPORTED_MODULE_6__["useFetch"])("https://statsapi.web.nhl.com/api/v1/teams/"),
      _useFetch4 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_useFetch3, 2),
      data = _useFetch4[0],
      loading = _useFetch4[1];
  ...
  if (!loading) {
    teams.forEach(function (team) {
      ...
      // }
      var standingsData = getStats(team.id);
...
//# sourceMappingURL=team-standings.js.079fac5bd79a20e4f34d.hot-update.js.map