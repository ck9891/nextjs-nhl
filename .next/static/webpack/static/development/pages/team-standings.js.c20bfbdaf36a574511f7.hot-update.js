...
var TeamStandings = function TeamStandings(props) {
  ...
  if (state === '') {
    var _useFetch = Object(_components_hooks__WEBPACK_IMPORTED_MODULE_8__["useFetch"])("https://statsapi.web.nhl.com/api/v1/teams/"),
        ...
        _data = _useFetch2[0],
        _setTeam = _useFetch2[1];
  } else {
    var _useFetch3 = Object(_components_hooks__WEBPACK_IMPORTED_MODULE_8__["useFetch"])("https://statsapi.web.nhl.com/api/v1/teams/"),
        _useFetch4 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_useFetch3, 2),
        _data2 = _useFetch4[0],
        _setTeam2 = _useFetch4[1];
  }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            nhlTeams = nhlData.teams; // console.log(nhlTeams);
...
//# sourceMappingURL=team-standings.js.c20bfbdaf36a574511f7.hot-update.js.map