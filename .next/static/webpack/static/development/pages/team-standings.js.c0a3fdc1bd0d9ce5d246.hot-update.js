...
var TeamStandings = function TeamStandings(props) {
  ...
  var _useFetch = Object(_components_hooks__WEBPACK_IMPORTED_MODULE_6__["useFetch"])(state),
      ...
      data = _useFetch2[0],
      setTeam = _useFetch2[1]; // if (setTeam) {
  ...
  if (!setTeam) {
    ...
    teams.forEach(function (team) {
      ...
      // console.log(team)
      Object(_components_hooks__WEBPACK_IMPORTED_MODULE_6__["useFetch"])("https://statsapi.web.nhl.com/api/v1/teams/".concat(team.id, "/stats"));
      standings.push({
        id: team.id,
        name: team.name
      });
...
//# sourceMappingURL=team-standings.js.c0a3fdc1bd0d9ce5d246.hot-update.js.map